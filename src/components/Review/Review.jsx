  ...
  useEffect(() => {
    ...
    if (selectedCategories.length > 0) {
      filteredSubjects = filteredSubjects.filter((subject) =>
        selectedCategories.includes(subject.category_name)
      );
    }
  ...
  return (
    <>
      <div className="review-subject">
        ...
        <div className="review-subject-container3">
          <div className="subject-container">
            {subjects.length > 0 ? (
              subjects.map((subject) => (
                <div className="subject-card" key={subject.subject_id}>
                  <div className={getCategoryClass(subject.category_name)}>
                    <Link
